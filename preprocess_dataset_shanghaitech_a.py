...
def generate_data(im_path):
    ...
    im_w, im_h = im.size
    mat_path = im_path.replace('.jpg', '.mat').replace('images', 'density-maps').replace('IMG', 'GT_IMG')
...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='../Datasets/ShanghaiTechA',
                        help='original data directory')
    parser.add_argument('--data-dir', default='../Datasets/ShanghaiTechAPreprocessed/train',
